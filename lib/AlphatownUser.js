...
au.prototype = {
	...
	giveDou: function(cb, amount, note, toId){
        ...
        var giveDouPage = 'http://alphatown.com/api/user/' + toId + '/give_dou?needauth=1',
		    tractAyuanUrl = 'https://alphatown.com/accounts/transact ',
		    options = {headers: {'Cookie': this.getCookie(), 'User-Agent': 'NodeJS Cilent/sunshien1988/www.inodejs.net/weibo.com/music1988'}};
